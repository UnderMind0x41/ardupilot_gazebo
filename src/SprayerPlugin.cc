...
void SprayerPlugin::Impl::SpawnGroundMark(double x, double y)
{
  ...
  std::string sdf =
      ...
      "      <geometry>"
      "        <box>"
      "          <size>" + std::to_string(this->markRadius * 2.0) + " " +
                            std::to_string(this->markRadius * 2.0) + " 0.01</size>"
      "        </box>"
      "      </geometry>"
      "      <material>"
      "        <ambient>0.9 0.9 0.9 0.55</ambient>"
      "        <diffuse>0.9 0.9 0.9 0.55</diffuse>"
      "        <specular>0.3 0.3 0.3 0.3</specular>"
      "        <emissive>0.1 0.1 0.1 0.2</emissive>"
      "      </material>"
